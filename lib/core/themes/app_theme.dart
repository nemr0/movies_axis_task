...
///
/// [https://theme.ionicerrrrscode.com/]
///
...
class AppTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      primary: Color(0xFF50afdc),
      surfaceTint: Color(0xFF50afdc),
      onPrimary: Color(0xFF000000),
      primaryContainer: Color(0xFFa0ffff),
      onPrimaryContainer: Color(0xFF2887b4),
      secondary: Color(0xFF9dcca4),
      onSecondary: Color(0xFF000000),
      secondaryContainer: Color(0xFFedfff4),
      onSecondaryContainer: Color(0xFF75a47c),
      tertiary: Color(0xFF0c243e),
      onTertiary: Color(0xFFFFFFFF),
      tertiaryContainer: Color(0xFF5c748e),
      onTertiaryContainer: Color(0xFF000016),
      ...
      inversePrimary: Color(0xFF3c9bc8),
      primaryFixed: Color(0xFFa0ffff),
      onPrimaryFixed: Color(0xFF1473a0),
      primaryFixedDim: Color(0xFF8cebff),
      onPrimaryFixedVariant: Color(0xFF3c9bc8),
      secondaryFixed: Color(0xFFedfff4),
      onSecondaryFixed: Color(0xFF619068),
      secondaryFixedDim: Color(0xFFd9ffe0),
      onSecondaryFixedVariant: Color(0xFF89b890),
      tertiaryFixed: Color(0xFF5c748e),
      onTertiaryFixed: Color(0xFF000002),
      tertiaryFixedDim: Color(0xFF48607a),
      onTertiaryFixedVariant: Color(0xFF00102a),
  ...
  static ColorScheme darkScheme() {
    return const ColorScheme(
      ...
      primary: Color(0xFF3c9bc8),
      surfaceTint: Color(0xFF3c9bc8),
      onPrimary: Color(0xFF005f8c),
      primaryContainer: Color(0xFF1473a0),
      onPrimaryContainer: Color(0xFFa0ffff),
      secondary: Color(0xFF89b890),
      onSecondary: Color(0xFF4d7c54),
      secondaryContainer: Color(0xFF619068),
      onSecondaryContainer: Color(0xFFedfff4),
      tertiary: Color(0xFF00102a),
      onTertiary: Color(0xFF000000),
      tertiaryContainer: Color(0xFF000002),
      onTertiaryContainer: Color(0xFF5c748e),
      ...
      inversePrimary: Color(0xFF50afdc),
      primaryFixed: Color(0xFFa0ffff),
      onPrimaryFixed: Color(0xFF1473a0),
      primaryFixedDim: Color(0xFF8cebff),
      onPrimaryFixedVariant: Color(0xFF3c9bc8),
