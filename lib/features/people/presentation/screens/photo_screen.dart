...
class PhotoScreen extends StatelessWidget {
  const PhotoScreen({super.key, required this.savePhotoParams});

  final SavePhotoParams savePhotoParams;

  @override
  Widget build(BuildContext context) {
    return LoaderOverlay(
      overlayWidgetBuilder: (_) => Center(child: CircularProgressIndicator.adaptive()),
      child: BlocListener<SavePhotoCubit, SavePhotoState>(
        ...
        child: BasicScreen(
          appBar: AppBar(
            ...
            actions: [
              CupertinoButton(
                onPressed: () {
                 context.read<SavePhotoCubit>().call(savePhotoParams);
                },
